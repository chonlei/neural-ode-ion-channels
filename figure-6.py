...
class Lambda(nn.Module):
    def __init__(self):
        ...
        # Fit to GroundTruth model using train-d0.py, in `./r0-bad/model-parameters.txt`.
        self.p1 = 1.907386659660279861e-04
        self.p2 = 4.884512388490065693e-02
        self.p3 = 1.331886974861103986e-05
        self.p4 = 6.220652138222864530e-02
...
if args.cached:
    pred_y_o_pr3 = torch.load('figure-6/y0-pr3.pt')
    pred_y_o_pr4 = torch.load('figure-6/y0-pr4.pt')
    pred_y_o_pr5 = torch.load('figure-6/y0-pr5.pt')
    ...
    with torch.no_grad():
        ...
        pred_y_o = predict(func, time1, voltage1, time1_torch, current1, g, true_y0, e, 'Pr3 (M0)')
        ...
        pred_y_o = predict(func, time2, voltage2, time2_torch, current2, g, true_y0, e, 'Pr4 (M0)')
        ...
        # Cache it
        torch.save(pred_y_o, 'figure-6/y0-pr4.pt')
        ...
        # Trained Neural ODE
        pred_y_o = predict(func, timep3, voltagep3, timep3_torch, currentp3, g, true_y0, e, 'Pr5 (M0)')
        ...
        # Cache it
        torch.save(pred_y_o, 'figure-6/y0-pr5.pt')
...
axes[1, 0].legend(loc='lower left', bbox_to_anchor=(-0.02, 1.55), ncol=4,
                  columnspacing=3, #handletextpad=1,
